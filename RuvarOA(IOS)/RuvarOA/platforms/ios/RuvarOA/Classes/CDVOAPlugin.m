...
#import "CDVOAPlugin.h"
#import "XGPush.h"
#import "MainViewController.h"
#import <SystemConfiguration/CaptiveNetwork.h>
@implementation CDVOAPlugin


/* 获取信息wifi信息  */
- (void)WifiInfo:(CDVInvokedUrlCommand *)command
    {
        NSLog(@"%s","OAPlugin============>Action_WifiInfo,nocomperlied");
...
{
	NSLog(@"%s","OAPlugin============>XG_GetToken,nocomperlied");
...
{
    NSLog(@"OAPlugin=========>startoread logininfo");
	CDVPluginResult* pluginResult=nil;
    ...
    NSLog(@"OAPlugin==========>endtoread logininfo");
	[self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
}
/* 信鸽返回Url参数地址 */
