...
var action = {
	HRMPlugin : {/* 第一个接口 */
        ...
        Action_WifiInfo : "WifiInfo",// 获取WIFI
...
var goHome=function(){
	...
	cordova.exec(
			...
			action.HRMPlugin.Action_GoHome,
			[]
		);
	}
	catch(e){}
...
var goLogin=function(backurl){
	var jsonData="[{";
	jsonData+=actionData.HRMPlugin.GoLogin+":\""+backurl+"\"";
	jsonData+="}]";
        ...
        $.ajax({ //一个Ajax过程
                ...
                success: function (result) {
                    if(result.ret_code=="0"){
                        ...
                        cordova.exec(null,null,action.HRMPlugin.Name,action.HRMPlugin.Action_GoLogin,json);
                    }else{
...
var serviceurl="/hrmapp/login/gotoLogin.shtml";
...
var doExit=function(){
    ...
    '确定退出？', // message
     function(bindex){            // callback to invoke with index of button pressed
     	if(bindex==1){
     		cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.HRMPlugin.Action_Exit,[]);
     	}
     },
    '退出',           // title
    ['确定','取消']     // buttonLabels
	...
	/*if(confirm("确定退出？")){
		cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.OAPlugin.Action_Exit,[]);
	}*/
};
...
var ClearCache=function(){
     	cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.HRMPlugin.Action_ClearCathe,[]);
        J.showToast('清理成功！');
	/*if(confirm("确定退出？")){
		cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.OAPlugin.Action_Exit,[]);
	}*/
...
var ClearLocalStorage=function(){
     	cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.HRMPlugin.Action_ClearLocalStorage,[]);
        J.showToast('清理LS成功！');
	/*if(confirm("确定退出？")){
		cordova.exec(function(){},function(){},action.HRMPlugin.Name,action.OAPlugin.Action_Exit,[]);
	}*/
